...
public:
    ...
    SkeletonGraphPlanner(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private);
    ...
    void setSparseGraph(const voxblox::SparseSkeletonGraph* sparse_graph);
    ...
    // Utilities...
    void convertCoordinatePathToPath(const voxblox::AlignedVector<voxblox::Point>& coordinate_path, mav_msgs::EigenTrajectoryPointVector* path) const;

    void shortenPath(const mav_msgs::EigenTrajectoryPoint::Vector& path_in, mav_msgs::EigenTrajectoryPoint::Vector* path_out) const;
